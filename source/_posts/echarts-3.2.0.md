...
3.2.0 是 ECharts 进入 3 之后最大的一次版本升级，新加的特性中有些是大家提了很久的，有些是我们自己想了很久的，有些我们在实现后光看看效果都觉得非常激动，有些看起来没啥差但是我们也在底层做了很多工作。

这个版本我们憋了一个多月，希望不会让大家失望。
...
在上面两个优化后 http://echarts.baidu.com/gallery/editor.html?c=bar-animation-delay 示例 2 个系列，每个系列 2k 的数据（也就是总共 4k+ 的图形）的初始动画从原先卡顿的 10 fps 提升到了流畅的 30 fps，而且这些 zrender 的优化都对展示效果和上层 echarts 的开发没有什么影响和副作用。
