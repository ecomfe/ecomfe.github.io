(function(){
    ...
    function getResourcePath(path) {
        ...
        return '../../server/proxy.php?bucket=heroes&object=' + path
        // return path;
    }
    ...
    // Sound
    var soundList = [
        getResourcePath('sounds/gamestartup1.mp3'),
        getResourcePath('sounds/gamestartup2.mp3'),
        getResourcePath('sounds/gamestartup3.mp3'),
        getResourcePath('sounds/ui_underscore1.mp3'),
        getResourcePath('sounds/world_map.mp3')
    ];
    var isPlay = true;
    var audio = document.createElement('audio');
    audio.addEventListener('ended', pick);
    function pick() {
        audio.src = soundList[Math.floor(Math.random() * 5)];
        audio.play();
    }
    pick();
